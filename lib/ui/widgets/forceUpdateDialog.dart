          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(UiUtils.getTranslatedLabel(context, newVersionAvailableSubTitleLabel),
                  textAlign: TextAlign.center, maxLines: 4, style: TextStyle(color: Theme.of(context).colorScheme.onSecondary, fontSize: 12)),
              const SizedBox(
                height: 22,
              ),
              GestureDetector(
                ...
                child: Container(
                    ...
                    child: Text(UiUtils.getTranslatedLabel(context, yesLabel),
                        textAlign: TextAlign.center, maxLines: 1, style: const TextStyle(color: white, fontSize: 16, fontWeight: FontWeight.w500))),
              ),
            ],
          ),
        ),
