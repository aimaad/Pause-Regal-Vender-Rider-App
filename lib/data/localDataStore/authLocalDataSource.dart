...
class AuthLocalDataSource {
  ...
  String? getForgottenPasswordSelector() {
    return Hive.box(authBox)
        .get(forgottenPasswordSelectorKey, defaultValue: "");
  }
  ...
  String? getCommissionMethod() {
    return Hive.box(authBox).get(commissionMethodKey, defaultValue: "");
  }

  String? getCommission() {
    return Hive.box(authBox).get(commissionKey, defaultValue: "");
  }

  String? getCashReceived() {
    return Hive.box(authBox).get(cashReceivedKey, defaultValue: "");
  }
  ...
  Future<void> setForgottenPasswordSelector(
      String? forgottenPasswordSelector) async {
    Hive.box(authBox)
        .put(forgottenPasswordSelectorKey, forgottenPasswordSelector);
  }
  ...
  Future<void> setActive(String? active) async {
    Hive.box(authBox).put(activeKey, active);
  }
  ...
  Future<void> setCommissionMethod(String? commissionMethod) async {
    Hive.box(authBox).put(commissionMethodKey, commissionMethod);
  }

  Future<void> setCommission(String? commission) async {
    Hive.box(authBox).put(commissionKey, commission);
  }

  Future<void> setCashReceived(String? cashReceived) async {
    Hive.box(authBox).put(cashReceivedKey, cashReceived);
  }
